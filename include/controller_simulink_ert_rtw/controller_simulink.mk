...
MODEL                   = controller_simulink
MODULES                 = controller_simulink_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp 
MAKEFILE                = controller_simulink.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2012a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2012a
MASTER_ANCHOR_DIR       = 
START_DIR               = /home/mafilipp/Dropbox/Fokusprojekt/21_Copter/MATLAB/11_code_generation
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
MODELLIB                  = controller_simulinklib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/controller_simulink_ert_rtw \
	-I$(START_DIR) \
